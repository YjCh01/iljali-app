...
import 'package:map/features/admin/presentation/panels/admin_announcements_panel.dart';
...
import 'package:map/features/admin/presentation/panels/admin_workplace_mismatch_panel.dart';
...
class _AdminWebShellPageState extends State<AdminWebShellPage> {
  ...
  Widget _buildPanel() {
    switch (_section) {
      ...
      case AdminNavSection.announcements:
        return AdminAnnouncementsPanel(controller: _controller);
      ...
      case AdminNavSection.pilot:
        return AdminPilotPanel(controller: _controller);
