...
2. 인력공급·파견·아웃소싱·용역 목적으로 푸시·매칭 기능만 이용하는 행위를 금지합니다.
3. 해당 업종 사업자는 Enterprise 파트너십 가입 및 관리자 승인이 필수입니다.
4. BASIC(무과금) 플랜은 푸시·공고 등록만 가능하며, 지원자 연락·채팅·즉시 확정은 완전히 차단됩니다. Starter 이상 파트너십 가입 후 이용 가능합니다.
5. 월정액 미결제 시 푸시 매칭 후 오프플랫폼 유도·연락처 공유를 기술적으로 차단합니다.
