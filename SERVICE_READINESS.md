...
4. `customer_support_page.dart` — FAQ + support@iljari.co.kr
5. `legal_documents_page.dart` — 이용약관·개인정보 탭 (플레이스홀더)
...
```
COMPLIANCE_API_URL=http://127.0.0.1:8000
```
